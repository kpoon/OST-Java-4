...
/**
 * This is the login for the SimplePhoneBook application. The login screen
...
class PasswordDialog extends JDialog implements ActionListener {
	...
	/* PasswordDialog */
    /**
    * The PasswordDialog constructor. Creates a dialog box with two text fields
    * and two buttons.
    ...
    */ 
	...
	/* main */
    /**
     * The entry point for the login screen. The main method instantiates the
     ...
     * @param sender    object who requested login is the  sender.
     */

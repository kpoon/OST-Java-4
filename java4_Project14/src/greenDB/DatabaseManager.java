...
public class DatabaseManager {
    ...
    private String [] initListingsTable() {
        ...
        String[]  SQL = {
            ...
            "LISTINGS_ID int (10) NOT NULL AUTO_INCREMENT," +
     ...
     * <pre>
     * PRE:  Connection to database has been established. Query is assigned and is a simple
     *       select statement on the Listings table.
     * POST: The query is executed.
     * </pre>
     */
    public void doWildCardQuery(){
        try {
          rset = stmt.executeQuery("SELECT * FROM Listings");
        } catch (SQLException e) {
          e.printStackTrace();
        }
    }
     ...
     * <pre>
     * PRE:  Connection to database has been established. Statement has been created. Listings is a table in the database
     * POST: If remove is true, table Listings is dropped, otherwise it is saved.  Open Connection and Statement are closed
     * </pre>
     * @param remove boolean to specify if the table Listings should be dropped or saved.
     */  

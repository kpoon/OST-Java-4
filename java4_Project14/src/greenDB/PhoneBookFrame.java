...
class PhoneBookFrame extends JFrame {
    ...
    public PhoneBookFrame() {
        ...
        JButton exitButton = new JButton("Exit"); //exit the app
        ...
        gb.setConstraints(exitButton, gbc);
        east.setLayout(gb);
        east.add(add);
        east.add(space);
        east.add(rem);
        ...
        // When user exits the application. Ask if they want to delete the table or save the table before exiting.
        exitButton.addActionListener(
            new ActionListener() {
            	public void actionPerformed(ActionEvent aEvent) {
                    Object[] options = {"Delete", "Save"};
                    int n = JOptionPane.showOptionDialog(null,
                        "Would you like to delete this table or save it?",
                        "Exit options",
    ...
    class GetListener implements ActionListener {  // Gets the entries from the text fields
         ...
         * character before the query is executed.  If user enters * in any field, then all records are returned.
         * <pre>
        ...
        public void actionPerformed(ActionEvent aEvent) {
            ...
            if(last.length()  > 0 ||
             ...
             pre.length()   > 0 ||
             sfx.length()   > 0) {
                if(last.equals("*") || first.equals("*") || ac.equals("*") || pre.equals("*") || sfx.equals("*")) {
                	// if user enters * in any field, then all records are returned.
         ...
         * The select statement is returned as a string. The select statement includes the ID, last, first, ac,
        ...
        public String buildQuery(String last, String first, String ac, String pre, String sfx) {
            ...
            return "select LISTINGS_ID, LAST_NAME, FIRST_NAME, AREA_CODE, PREFIX, SUFFIX from Listings" + whereClause;
        }

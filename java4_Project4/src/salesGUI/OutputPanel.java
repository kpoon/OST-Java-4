...
public class OutputPanel extends JPanel {
	...
	protected void writeMinMaxOutput() {
		app.calculateMinMax();
		DecimalFormat df1 = new DecimalFormat("####.##");
		//Build the output string like an HTML doc
		String txtOutput = 
				"<html>Min and Max Figures<br>__________________<br>";
	...
	protected void writeOutput() {
		...
		//Build the output string like an HTML doc
		String txtOutput = 
				"<html>Sales Figures<br>__________________<br>";
	...
	protected String createSalesBarInfo() {
		...
		for (int x = 0; x < sales.length; x++) {
			if (performance[x] ==1) {
		        ...
		        salesBarOutput += "Sales person " + (x + 1) +
		            " did not reach the sales goal with sales of $" + df1.format(sales[x]) + "<br>";
		      }
		}
		if (overSalesBar == 1)
